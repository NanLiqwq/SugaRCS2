...
namespace GUI
{
	...
	void NewGui()
	{
		...
		ImGui::Begin("SugaR", nullptr, Flags);
		{
			...
			ImGui::BeginChild("Page", MenuConfig::WCS.ChildSize);
			{
				...
				if (MenuConfig::WCS.MenuPage == 2)
				{
					...
					ImGui::SameLine();
					if (ImGui::Combo("###Theme", &MenuConfig::Theme, "AimStar\0NeverLose\0AIMWARE\0Custom\0SugaR\0"))
					...
					if (ImGui::Button(ICON_FA_COPY " Source Code", { ImGui::GetColumnWidth() - 20.f, 25.f }))
						Gui.OpenWebpage("https://github.com/NanLiqwq/SugaRCS2/");
					ImGui::SetCursorPosX(ImGui::GetCursorPosX() + 5.f);
					if (ImGui::Button(ICON_FA_COMMENT_DOTS " Join AS Discord", { ImGui::GetColumnWidth() - 20.f, 25.f }))
						Gui.OpenWebpage("https://discord.com/invite/VgRrxwesPz");

					if (MenuConfig::Country == "CN")
					{
						ImGui::SetCursorPosX(ImGui::GetCursorPosX() + 5.f);
						if (ImGui::Button(ICON_FA_COMMENT_DOTS "AS QQ Group", { ImGui::GetColumnWidth() - 20.f, 25.f }))
