...
{
	char TempText[256];
	ImGui::Begin("SugaR", nullptr, ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoCollapse);
	{
		ImGui::BeginTabBar("SugaR", ImGuiTabBarFlags_Reorderable | ImGuiTabBarFlags_FittingPolicyScroll | ImGuiTabBarFlags_NoTooltip);
		...
		if (ImGui::BeginTabItem(TempText))
		{
			...
			if (ImGui::Combo(Lang::MiscText.ThemeList, &MenuConfig::MenuStyle, "SugaR\0Enemy\0Hacker\0Red\0Modern Dark\0Deep Dark\0Round Gray\0Square Dark\0Egirl\0Trans\0"))
				StyleChanger::UpdateSkin(MenuConfig::MenuStyle);
			if (ImGui::Combo(Lang::MiscText.StyleList, &MenuConfig::WindowStyle, "Osiris\0SugaR\0"))
		...
		if (ImGui::BeginTabItem(TempText))
		{
			...
			Gui.OpenWebpageButton(TempText, "https://github.com/NanLiqwq/SugaRCS2/");
			ImGui::SameLine();
			ImGui::NewLine();
